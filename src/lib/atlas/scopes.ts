...
import { GALAXY_ZEMI, SOLAR_SYSTEM_ZEMI, moonScopeId, planetScopeId, type Scope } from "./galaxy";
import { loadBodies } from "./bodies";
import { ARM_META } from "@/data/arms";

export { GALAXY_ZEMI, SOLAR_SYSTEM_ZEMI, moonScopeId, planetScopeId, type Scope } from "./galaxy";
...
export const SCOPES: Record<ScopeId, Scope> = {
  ...
  [SOLAR_SYSTEM_ZEMI.id]: SOLAR_SYSTEM_ZEMI,
